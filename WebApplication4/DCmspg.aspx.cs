...
namespace WebApplication4
{
    public partial class DCmspg : System.Web.UI.Page
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            suplr_tb.Text = GridView1.SelectedRow.Cells[4].Text;
            manuf_tb.Text = GridView1.SelectedRow.Cells[5].Text;
            orgn_tb.Text = GridView1.SelectedRow.Cells[6].Text;
            sub_con_tb.Text = GridView1.SelectedRow.Cells[7].Text;
            dspln_tb.Text = GridView1.SelectedRow.Cells[8].Text;
            app_dt_tb.Text = Convert.ToString( GridView1.SelectedRow.Cells[9].Text);
            status_tb.Text = GridView1.SelectedRow.Cells[10].Text;
            ltr_ref_tb.Text = GridView1.SelectedRow.Cells[11].Text;
            msi_tb.Text = GridView1.SelectedRow.Cells[12].Text;
            lllli_tb.Text = GridView1.SelectedRow.Cells[13].Text;
            cur_stat_sub_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[14].Text);
            cur_stat_rsp_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[15].Text);
            cur_stat_tb.Text = GridView1.SelectedRow.Cells[16].Text;
            cur_stat_rev_tb.Text = GridView1.SelectedRow.Cells[17].Text;
            no_of_dys_tb.Text = GridView1.SelectedRow.Cells[18].Text;
            remrk_tb.Text = GridView1.SelectedRow.Cells[19].Text;
            rev0_sub_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[21].Text);
            rev0_ret_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[22].Text);
            rev0_stat_tb.Text = GridView1.SelectedRow.Cells[23].Text;
            rev1_sub_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[24].Text);
            rev1_ret_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[25].Text);
            rev1_stat_tb.Text = GridView1.SelectedRow.Cells[26].Text;
            rev2_sub_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[27].Text);
            rev2_ret_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[28].Text);
            rev2_stat_tb.Text = GridView1.SelectedRow.Cells[29].Text;
            rev3_sub_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[30].Text);
            rev3_ret_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[31].Text);
            rev3_stat_tb.Text = GridView1.SelectedRow.Cells[32].Text;
            rev4_sub_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[33].Text);
            rev4_ret_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[34].Text);
            rev4_stat_tb.Text = GridView1.SelectedRow.Cells[35].Text;
            rev5_sub_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[36].Text);
            rev5_ret_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[37].Text);
            rev5_stat_tb.Text = GridView1.SelectedRow.Cells[38].Text;
            rev6_sub_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[39].Text);
            rev6_ret_dt_tb.Text = Convert.ToString(GridView1.SelectedRow.Cells[40].Text);
            rev6_stat_tb.Text = GridView1.SelectedRow.Cells[41].Text;
